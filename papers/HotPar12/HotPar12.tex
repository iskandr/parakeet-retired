...
These "data parallel" operators form the basic units of parallelism in Parakeet. Array operations encode rich information about their access patterns that we can exploit to translate them into efficient parallel programs~\cite{Ju94}.
