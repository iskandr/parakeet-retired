...
Unlike many other systems similar to Parakeet \cite{Cata11,Chaf11}, our back end doesn't emit CUDA code to be compiled by the NVIDIA CUDA compiler.  Instead, we target PTX, NVIDIA's GPU pseudoassembly language.
