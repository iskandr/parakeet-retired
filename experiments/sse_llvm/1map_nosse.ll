define void @"map_wrapper_nosse[array1<int64>]"(i64 %input, i64 %output) {
entry:
...
loop:                                             ; preds = %cond
  ...
  %idxAddr = inttoptr i64 %idxAddrInt to i64*
  ...
  %idxAddr12 = inttoptr i64 %idxAddrInt11 to i64*
  %ret = load i64* %idxAddr12, align 8
  %multmp = mul i64 %ret, 3
  store i64 %multmp, i64* %idxAddr, align 8
  %addtmp = add i32 %loop_idx.0, 1
  br label %cond
