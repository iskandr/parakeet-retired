...
and eval_exp (expNode : SSA.exp_node) : Value.t list = 
...
and eval_scalar_op (op : Prim.scalar_op) (args : Value.t list) =
...
and eval_array_op (op : Prim.array_op) (argVals : Value.t list) : Value.t list =
